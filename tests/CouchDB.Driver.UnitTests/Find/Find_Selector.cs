...
public class Find_Selector : HttpTests
{
    [Fact]
    ...
    public void ComplexQuery()
    {
        var json = Rebels
            ...
            .ToString();
        Assert.Equal(
            @"{""selector"":{""$and"":[{""age"":19},{""$or"":[{""name"":""Luke""},{""name"":""Leia""}]},{""skills"":{""$all"":[""force""]}}]}}",
            json);
    }
    ...
    public void MultiWhereQuery()
    {
        var json = Rebels
            ...
            .ToString();
        Assert.Equal(
            @"{""limit"":1,""selector"":{""$and"":[{""age"":19},{""$or"":[{""name"":""Luke""},{""name"":""Leia""}]},{""skills"":{""$all"":[""force""]}}]}}",
            json);
    }
    ...
    {
        var json = Rebels.Where(r => r.Name == @"Chewbacca (""Chewie"")").ToString();
