...
public class Find_Selector_Combinations : HttpTests
{
    [Fact]
    public void And_HttpCall()
    {
        ...
        var result = Rebels.Where(r => r.Name == "Luke" && r.Surname == surname).ToList();
    ...
    {
        var surname = "Skywalker";
        var json = Rebels.Where(r => r.Name == "Luke" && r.Surname == surname).ToString();
    ...
    {
        var json = Rebels.Where(r => r.Battles.Any(b => b.DidWin)).ToString();
    ...
    {
        var json = Rebels.Where(r => r.Battles.Any(b => b.DidWin == true)).ToString();
        Assert.Equal(@"{""selector"":{""battles"":{""$elemMatch"":{""didWin"":true}}}}", json);
    }
    ...
    {
        var json = Rebels.Where(r => r.Battles.Any(b => b.Vehicles.Any(v => v.CanFly == true))).ToString();
        Assert.Equal(
    ...
    {
        var json = Rebels.Where(r => r.Battles.Any(b => b.Vehicles.Any(v => v.CanFly))).ToString();
        Assert.Equal(
            @"{""selector"":{""battles"":{""$elemMatch"":{""vehicles"":{""$elemMatch"":{""canFly"":true}}}}}}",
            json);
    }
    ...
    public void ElemMatch_In()
    {
        ...
        var json = Rebels.Where(r => r.Skills.Any(s => s.In(search))).ToString();
    ...
    {
        var json = Rebels.Where(r => r.Battles.All(b => b.DidWin)).ToString();
