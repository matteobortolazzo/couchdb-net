...
public class DocumentCaseType : CaseType
{
    ...
    /// </summary>
    public static readonly DocumentCaseType None = new("None");
    /// <summary>
    /// Represents underscore_case or snake_case.
    /// </summary>
    public static readonly DocumentCaseType UnderscoreCase = new("UnderscoreCase");        
    /// <summary>
    /// Represents kebab-case.
    /// </summary>
    public static readonly DocumentCaseType KebabCase = new("KebabCase");
